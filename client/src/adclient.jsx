...
function Adclient({ slide, here }) {
  ...
  function adcl(event) {
    ...
    if (
      ...
      axios
        .post("https://mitzvah-software-for-smart-air-curtain.onrender.com/add2", formData)
        .then(() => {
          setdone(1);
          setchan(0);
          setname(0);
  ...
  useEffect(() => {
    if (called === 1) {
      ...
      axios
        .post("https://mitzvah-software-for-smart-air-curtain.onrender.com/get-name", { client_name: formData.name })
        .then((res) => {
